...
public interface Header extends Serializable  {
	...
	/**
	 * Return the destination address in this ISOHeader. returns null if there
	 * is no destination address
	 */
	...
	/**
	 * Return the source address in this ISOHeader. returns null if there is no
	 * source address
	 */
	...
	/**
	 * Swap the source and destination addresses in this ISOHeader (if they
	 * exist).
	 */
